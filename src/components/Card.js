      ...
      <div className="texts  flex flex-col gap-2 px-5 pb-5">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className=" uppercase bg-violet-500 text-violet-50 font-medium py-3 px-10 rounded-md hover:bg-orange-500 hover:text-orange-50 duration-300 shadow-sm shadow-violet-300 hover:shadow-orange-300"
          >
            Add to cart
          </button>
        </div>
